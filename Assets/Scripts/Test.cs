...
public class Test : MonoBehaviour
{
    ...
    public GameObject pivotObject; // The central pivot object (assign in the Inspector)
    public float rotationSpeed = 100f; // Rotation speed (degrees per second)
    public float maxRotation = 50f; // Maximum rotation in degrees to the left and right
